...
{
    public partial class UC_Livros : UserControl, IFerramentas
    {
        public UC_Livros()
        {
            InitializeComponent();
        ...
        public void AbrirFicha()
        {
            try
            {
                ...
                MySqlCommand comando = new MySqlCommand("SELECT ID, Titulo, Subtitulo, Colecao, Autor, Volume, Unico, Editora, Genero, Edicao, Proprietario, Observacoes FROM livros WHERE ID = ?", conexao);
        ...
        public void SalvarFicha()
        {
            ...
            try
            {
                ...
                MySqlCommand comando = new MySqlCommand("INSERT INTO livros (ID, Titulo, Subtitulo, Colecao, Autor, Volume, Unico, Editora, Genero, Edicao, Proprietario, Observacoes) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", conexao);
                comando.Parameters.Add("@ID", MySqlDbType.Int64, 15).Value = Txt_Id.Text;
                ...
                comando.Parameters.Add("@Unico", MySqlDbType.Int16, 1).Value = unico.ToString();
        ...
        public void AlterarFicha()
        {
            ...
            try
            {
                ...
                MySqlCommand comando = new MySqlCommand("UPDATE livros SET Titulo = ?, Subtitulo = ?, Colecao = ?, Autor = ?, Volume = ?, Unico = ?, Editora = ?, Genero = ?, Edicao = ?, Proprietario = ?, Observacoes = ? WHERE ID = ?", conexao);
                comando.Parameters.Clear();
                comando.Parameters.Add("@Titulo", MySqlDbType.VarChar, 75).Value = Txt_Titulo.Text;
                comando.Parameters.Add("@Subtitulo", MySqlDbType.VarChar, 75).Value = Txt_Subtitulo.Text;
                comando.Parameters.Add("@Colecao", MySqlDbType.VarChar, 75).Value = Txt_Colecao.Text;
        ...
        public void ApagarFicha()
        {
            try
            {
                ...
                MySqlCommand comando = new MySqlCommand("DELETE FROM livros WHERE ID = ?", conexao);
                comando.Parameters.Clear();
                comando.Parameters.Add("@ID", MySqlDbType.Int64, 15).Value = Txt_Id.Text;
                comando.ExecuteNonQuery();
        ...
        public void BuscarFichas()
        {
            try
            {
                ...
                MySqlCommand comando = new MySqlCommand("SELECT ID, Titulo, Subtitulo, Autor FROM livros WHERE ID LIKE ? OR Titulo LIKE ? OR Subtitulo LIKE ? OR Colecao LIKE ? OR Autor LIKE ? OR Volume LIKE ? OR Unico LIKE ? OR Editora LIKE ? OR Genero LIKE ? OR Edicao LIKE ? OR Proprietario LIKE ? OR Observacoes LIKE ?", conexao);
                comando.Parameters.Clear();
